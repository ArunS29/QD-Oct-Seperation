...
namespace QD.ERP.Finance.Areas.Finance.Reports.ExpensesClaims
{
	public partial class PaymentsAdviceSupplierPayments : DevExpress.XtraReports.UI.XtraReport
	{
        ...
        public PaymentsAdviceSupplierPayments(string voucherNo, string tenantName, string companyName, string companyAddress, Image logoImage, string companyNameAr, string companyAddressAr, TenantDbContextHelper tenantDbContextHelper)
        {
        ...
        private void LoadCurrencySymbolAndImage()
        {
            try
            {
                ...
                string[] pictureBoxNames = { "xrPictureBox2",  "xrPictureBox4", "xrPictureBox5", "xrPictureBox6", "xrPictureBox7", "xrPictureBox8", "xrPictureBox3", "xrPictureBox10", "xrPictureBox11", "xrPictureBox12" };
        ...
        {
            var fixedPictureBoxes = new[] { "xrPictureBox2", "xrPictureBox3", "xrPictureBox4", "xrPictureBox8" };

	...
	public partial class employeecostJournalRegister : DevExpress.XtraReports.UI.XtraReport
	{
        ...
        private void LoadCurrencySymbolAndImage()
        {
            try
            {
                ...
                string[] pictureBoxNames = { "xrPictureBox2", "xrPictureBox4", "xrPictureBox5", "xrPictureBox6", "xrPictureBox7", "xrPictureBox8", "xrPictureBox9", "xrPictureBox10", "xrPictureBox3", "xrPictureBox12" };
        ...
        {
            string[] pictureBoxNames = { "xrPictureBox2", "xrPictureBox4", "xrPictureBox5", "xrPictureBox6", "xrPictureBox7", "xrPictureBox8", "xrPictureBox9", "xrPictureBox3", "xrPictureBox11", "xrPictureBox12" };

...
{
    public partial class rpt20124SubLedgerForAccountStatement : XtraReport
    {
        public rpt20124SubLedgerForAccountStatement()
        {
            InitializeComponent();
        }
        ...
        public void LoadData(string voucherNo, string connectionString)
        {
            ...
            try
            {
                ...
                {
                    string query = @"SELECT * FROM [tbl201SubLedgerMaster] 

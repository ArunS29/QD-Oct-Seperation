...
using Svg;
using System.Text;
using Microsoft.Data.SqlClient; // For TenantDbContextHelper

namespace QD.ERP.Finance.Areas.Finance.Reports.Cost_Analysis.Detailed_Report
{
    public partial class detailGroupBydate : XtraReport
    {
        private readonly TenantDbContextHelper _tenantDbContextHelper;

        public detailGroupBydate(
            string requestedBy,
            DateTime frmDate,
            DateTime toDate,
            string tenantName,

    ...
    public partial class Group : XtraReport
    {
        ...
        private void LoadCurrencySymbolAndImage()
        {
            try
            {
                ...
                string[] pictureBoxNames = { "xrPictureBox1", "xrPictureBox4", "xrPictureBox5", "xrPictureBox6", "xrPictureBox7", "xrPictureBox8", "xrPictureBox9", "xrPictureBox10", "xrPictureBox11", "xrPictureBox12" };
        ...
        {
            var fixedPictureBoxes = new[] {"xrPictureBox3", "xrPictureBox4", "xrPictureBox5", "xrPictureBox1" };

...
{
    public partial class BillsPayablesAgeingasperLedgerBalanceByEndDate : XtraReport
    {
        private readonly TenantDbContextHelper _tenantDbContextHelper;

        public BillsPayablesAgeingasperLedgerBalanceByEndDate(
            string accountGroup,
            DateTime frmDate,
            DateTime toDate,
            string tenantName,
        ...
        private void ConfigureSqlDataSource()
        {
            ...
            {
                Name = "qry205_027AgeingBillsReceivableWtColumns", // You can change this as per your actual query/view

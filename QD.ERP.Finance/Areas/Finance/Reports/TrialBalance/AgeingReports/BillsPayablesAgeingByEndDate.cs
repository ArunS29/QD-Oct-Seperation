...
{
    public partial class BillsPayablesAgeingByEndDate : XtraReport
    {
        private readonly TenantDbContextHelper _tenantDbContextHelper;

        public BillsPayablesAgeingByEndDate(
            string accountGroup,
            DateTime frmDate,
            DateTime toDate,
            string tenantName,
        ...
        private void ConfigureSqlDataSource()
        {
            ...
            {
                Name = "qry205_027AgeingBillsReceivableWtColumns", // Change this to the appropriate query name
                Sql = "SELECT * FROM qry205_027AgeingBillsReceivableWtColumns" // Update this to match your payables query
            };

...
{
    public partial class BillsReceivablesSummaryAgeingasperLedgerBalanceByEndDate : DevExpress.XtraReports.UI.XtraReport
    {
        private readonly TenantDbContextHelper _tenantDbContextHelper;

        public BillsReceivablesSummaryAgeingasperLedgerBalanceByEndDate(
            string accountGroup,
            DateTime frmDate,
            DateTime toDate,
            string tenantName,

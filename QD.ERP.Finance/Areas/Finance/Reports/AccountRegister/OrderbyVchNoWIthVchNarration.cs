...
using Svg;
using System.Text; // For TenantDbContextHelper

namespace QD.ERP.Finance.Areas.Finance.Reports.AccountRegister
{
    public partial class OrderbyVchNoWIthVchNarration : XtraReport
    {
        private readonly TenantDbContextHelper _tenantDbContextHelper;

        // Constructor with TenantDbContextHelper injection
        public OrderbyVchNoWIthVchNarration(
            string voucherType,
            DateTime frmDate,
            DateTime toDate,
            string tenantName,
            ...
            TenantDbContextHelper tenantDbContextHelper,string username)
        {
            ...
            try
            {
                this.sqlDataSource1.Fill(); // Load data
        ...
        private void ConfigureSqlDataSource(string voucherType, DateTime frmDate, DateTime toDate)
        {
            ...
            new QueryParameter("@EndDate", typeof(DateTime), toDate)
                ...
                sqlDataSource1.Name = "sqlDataSource2";
            }
            else
            {

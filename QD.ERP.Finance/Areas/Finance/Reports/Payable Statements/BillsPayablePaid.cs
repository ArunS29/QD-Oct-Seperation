...
namespace QD.ERP.Finance.Areas.Finance.Reports.Payable_Statements
{
    public partial class BillsPayablePaid : XtraReport
    {
        ...
        {
            string[] pictureBoxNames = { "xrPictureBox2", "xrPictureBox3", "xrPictureBox4", "xrPictureBox5", "xrPictureBox6", "xrPictureBox7", "xrPictureBox8", "xrPictureBox9", "xrPictureBox10", "xrPictureBox11", "xrPictureBox12", "xrPictureBox13" };
        ...
        {
            var fixedPictureBoxes = new[] { "xrPictureBox10", "xrPictureBox11", "xrPictureBox12" };

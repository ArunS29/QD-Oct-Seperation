...
namespace QD.ERP.Finance.Areas.Finance.Reports.Receivable_Statements
{
    public partial class BillsReceivablelandscapeformat : XtraReport
    {
       // private const string QueryName = "qry201SubLedgerReceivablesMaster ";
        ...
        public BillsReceivablelandscapeformat(string accountId,
        DateTime frmDate,
            DateTime toDate,
            string tenantName,
            string companyName,
    ...
    else
    {
        ...
        private void LoadCurrencySymbolAndImage()
        {
            try
            {
                ...
                string[] pictureBoxNames = { "xrPictureBox2", "xrPictureBox4", "xrPictureBox5", "xrPictureBox9", "xrPictureBox10", "xrPictureBox11", "xrPictureBox15" };
        ...
        {
            var fixedPictureBoxes = new[] { "xrPictureBox9", "xrPictureBox10", "xrPictureBox11","xrPictureBox12" };
          ...
          new { Label = "xrLabel10",  Picture = "xrPictureBox4" },
          new { Label = "xrLabel5",  Picture = "xrPictureBox5" },
          new { Label = "xrLabel7",  Picture = "xrPictureBox2" },
         };

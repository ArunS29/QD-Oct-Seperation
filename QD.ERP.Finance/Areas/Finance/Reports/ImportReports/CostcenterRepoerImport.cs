...
{
    public partial class CostcenterRepoerImport : XtraReport
    {
        private readonly TenantDbContextHelper _tenantDbContextHelper;

        public CostcenterRepoerImport(
            string requestedBy,
            DateTime frmDate,
            DateTime toDate,
            string tenantName,
        ...
        {
            var fixedPictureBoxes = new[] { "xrPictureBox2", "xrPictureBox8" };
    ...
    new { Label = "xrLabel000",  Picture = "xrPictureBox0" },
};

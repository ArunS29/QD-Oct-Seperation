...
{
    public partial class DetailReportImport : XtraReport
    {
        private readonly TenantDbContextHelper _tenantDbContextHelper;

        public DetailReportImport(string requestedBy,
            DateTime frmDate,
            DateTime toDate,
            string tenantName,
            string companyName,
        ...
        {
            var fixedPictureBoxes = new[] { "xrPictureBox2", "xrPictureBox3", "xrPictureBox6", "xrPictureBox7" };

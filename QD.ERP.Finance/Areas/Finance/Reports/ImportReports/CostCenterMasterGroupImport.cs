...
{
    public partial class CostCenterMasterGroupImport : DevExpress.XtraReports.UI.XtraReport
    {
        private readonly TenantDbContextHelper _tenantDbContextHelper;

        public CostCenterMasterGroupImport(string requestedBy,
            DateTime frmDate,
            DateTime toDate,
            string tenantName,
            string companyName,
        ...
        public CostCenterMasterGroupImport()
        {
            InitializeComponent();

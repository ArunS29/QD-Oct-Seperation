...
{
    public partial class detailedMasterByDateImport : DevExpress.XtraReports.UI.XtraReport
    {
        private readonly TenantDbContextHelper _tenantDbContextHelper;

        public detailedMasterByDateImport(
            string requestedBy,
            DateTime frmDate,
            DateTime toDate,
            string tenantName,
        ...
        private void ConfigureSqlDataSource(string requestedBy, DateTime frmDate, DateTime toDate)
        {
            ...
            // Apply multi-tenant connection string

...
{
    public partial class SummaryImport : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void ConfigureSqlDataSource()
        {
            ...
            {
                Name = "tbl20156BillsPayableSummaryMaster",
                Sql = "SELECT * FROM tbl20156BillsPayableSummaryMaster"
            };

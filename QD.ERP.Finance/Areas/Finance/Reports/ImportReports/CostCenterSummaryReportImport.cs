...
{
    public partial class CostCenterSummaryReportImport : XtraReport
    {
        private readonly TenantDbContextHelper _tenantDbContextHelper;

        public CostCenterSummaryReportImport(
            string requestedBy,
            DateTime frmDate,
            DateTime toDate,
            string tenantName,
        ...
        {
            var fixedPictureBoxes = new[] { "xrPictureBox2", "xrPictureBox9" };

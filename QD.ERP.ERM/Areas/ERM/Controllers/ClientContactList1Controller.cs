...
namespace QD.ERP.Web.Areas.ERM.Controllers
{
    ...
    [ApiController]
    public class ClientContactList1Controller : Controller
    {
        private readonly TenantDbContextHelper _tenantDbContextHelper;
        private readonly ILogger<ClientContactList1Controller> _logger;
        public ClientContactList1Controller(ILogger<ClientContactList1Controller> logger, TenantDbContextHelper tenantDbContextHelper)
        {

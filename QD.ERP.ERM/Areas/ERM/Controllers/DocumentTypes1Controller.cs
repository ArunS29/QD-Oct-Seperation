...
namespace QD.ERP.Web.Areas.ERM.Controllers
{
    ...
    [ApiController]
    public class DocumentTypes1Controller : ControllerBase
    {
        private readonly TenantDbContextHelper _tenantDbContextHelper;
        private readonly ILogger<DocumentTypes1Controller> _logger;

        public DocumentTypes1Controller(ILogger<DocumentTypes1Controller> logger, TenantDbContextHelper tenantDbContextHelper)
        {

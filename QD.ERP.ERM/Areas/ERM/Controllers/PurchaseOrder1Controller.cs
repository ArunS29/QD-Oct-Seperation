...
namespace QD.ERP.ERM.Areas.ERM.Controllers
{
    ...
    [ApiController]
    public class PurchaseOrder1Controller : Controller
    {
        private readonly TenantDbContextHelper _tenantDbContextHelper;
        private readonly ILogger<PurchaseOrder1Controller> _logger;

        public PurchaseOrder1Controller(ILogger<PurchaseOrder1Controller> logger, TenantDbContextHelper tenantDbContextHelper)
        {

...
namespace QD.ERP.Web.Areas.ERM.Controllers
{
    ...
    [ApiController]
    public class GoodsandServices1Controller : ControllerBase
    {
        private readonly TenantDbContextHelper _tenantDbContextHelper;
		private readonly ILogger<GoodsandServices1Controller> _logger;

		public GoodsandServices1Controller(ILogger<GoodsandServices1Controller> logger, TenantDbContextHelper tenantDbContextHelper)
		{

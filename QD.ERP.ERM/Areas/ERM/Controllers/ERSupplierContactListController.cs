...
namespace QD.ERP.ERM.Areas.ERM.Controllers
{
    ...
    [ApiController]
    public class ERSupplierContactListController : Controller
    {
        private readonly TenantDbContextHelper _tenantDbContextHelper;
        private readonly ILogger<ERSupplierContactListController> _logger;
        public ERSupplierContactListController(ILogger<ERSupplierContactListController> logger, TenantDbContextHelper tenantDbContextHelper)
        {

...
namespace QD.ERP.Web.Areas.Finance.Controllers
{
	...
	public class JournalEntryPropertyAllocationController : Controller
	{
		...
		public JournalEntryPropertyAllocationController(ERPMasterWtDataContext context)
		{
			_context = context;
		}
		...
		public async Task<ActionResult> SaveJournalPropertyAllocation([FromBody] Tbl20130JournalRegisterPropertyAllocation CM)
		{
			...
			try
			{
				...
				long maxVoucherEntryID = await _context.Tbl20130JournalRegisterPropertyAllocations
				...
				_context.Tbl20130JournalRegisterPropertyAllocations.Add(CM);

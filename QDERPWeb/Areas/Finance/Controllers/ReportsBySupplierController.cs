...
namespace QD.ERP.Web.Areas.Finance.Controllers
{
    ...
    public class ReportsBySupplierController : Controller
    {
        ...
        public ReportsBySupplierController(ERPMasterWtDataContext context)
        {
            _context = context;
        }
        [HttpGet]
        public async Task<IActionResult> GetAccountHead(DataSourceLoadOptions loadOptions)
        {
            try
            {
                var AccountHeadData = _context.Qry20110SundryCreditors.Select(i => new
                {
                    i.AccountId,
                    i.AccountHead
                });
        ...
        //        Retrieve AccountId length from the database(adjust as needed)
        //        var accountIdsLength = _context.Qry20110SundryDebtors
        //                                       .Select(d => d.AccountId)
        //                                       .Count(); // You can change this to get the total count of AccountIds.
        ...
        //        Redirect to DocumentViewer with selected IDs
        //        return RedirectToPage("/Designer", new
        //        {
        //            reportName = "XtraReport1",
        //            selectedIds = ids
        //        });
        //    }
        //    catch (Exception ex)
        //    {
        //        Log the error or preserve the stack trace
        //        throw;
        //    }
        //}
        [HttpPost]
        public IActionResult GenerateReport([FromBody] string[] selectedIds)
        {
            try
            {
                ...
                var accountIdsLength = _context.Qry20110SundryCreditors
                                               .Select(d => d.AccountId)
                                               .Count();

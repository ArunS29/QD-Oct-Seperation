...
{
	public partial class IncomestatementsHorizondal : DevExpress.XtraReports.UI.XtraReport
	{
        private readonly TenantDbContextHelper _tenantDbContextHelper;
        public IncomestatementsHorizondal(string accountGroup,
                DateTime frmDate,
                DateTime toDate,
                string tenantName,
                string company_Name,
        ...
        public IncomestatementsHorizondal() { 
            InitializeComponent();
        }
        ...
        private void ConfigureSqlQuery(string accountGroup, DateTime frmDate, DateTime toDate)
        {
            var storedProcQuery = new StoredProcQuery
            {
                ...
                StoredProcName = "sp20101IncomeStatement_ByGroup "
            };

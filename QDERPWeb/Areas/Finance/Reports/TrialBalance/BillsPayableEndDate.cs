...
{
	public partial class BillsPayableEndDate : DevExpress.XtraReports.UI.XtraReport
	{
        private readonly TenantDbContextHelper _tenantDbContextHelper;
        public BillsPayableEndDate(string accountGroup,
                DateTime frmDate,
                DateTime toDate,
                string tenantName,
                string company_Name,
        ...
        private void ConfigureSqlQuery(string accountGroup, DateTime frmDate, DateTime toDate)
        {
            var storedProcQuery = new StoredProcQuery
            {
                ...
                StoredProcName = "qry205_017AgeingBillsPayableWtColumns"
            };

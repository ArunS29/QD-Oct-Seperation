...
{
	public partial class billsPayableSummaryLedgerBalance : DevExpress.XtraReports.UI.XtraReport
	{
        private readonly TenantDbContextHelper _tenantDbContextHelper;

        public billsPayableSummaryLedgerBalance(string accountGroup,
                DateTime frmDate,
                DateTime toDate,
                string tenantName,
                string company_Name,
        ...
        public billsPayableSummaryLedgerBalance()
        {
            InitializeComponent();
        }

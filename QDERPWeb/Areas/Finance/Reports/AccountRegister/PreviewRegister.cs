...
{
    public partial class PreviewRegister : DevExpress.XtraReports.UI.XtraReport
    {
        // Constructor with parameters to dynamically pass VoucherType, StartDate, EndDate, and company details
        public PreviewRegister(string voucherType, DateTime frmDate, DateTime toDate, string tenantName, string companyName, string companyAddress, Image logoImage, string companyNameAr, string companyAddressArb)
        {
            InitializeComponent();

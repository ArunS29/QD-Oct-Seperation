...
{
    public partial class OrderbyVchNoWIthVchNarration : DevExpress.XtraReports.UI.XtraReport
    {
        // Constructor with parameters to dynamically pass VoucherType, StartDate, EndDate, and company details
        public OrderbyVchNoWIthVchNarration(string voucherType, DateTime frmDate, DateTime toDate, string tenantName, string companyName, string companyAddress, Image logoImage, string companyNameAr, string companyAddressArb)
        {
            InitializeComponent();

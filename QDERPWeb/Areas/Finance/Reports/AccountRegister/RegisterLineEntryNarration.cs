...
namespace QD.ERP.Web.Areas.Finance.Reports.AccountRegister
{
    public partial class RegisterLineEntryNarration : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public RegisterLineEntryNarration(string voucherType, DateTime frmDate, DateTime toDate, string tenantName, string companyName, string companyAddress, Image logoImage, string companyNameAr, string companyAddressArb)
        {
            InitializeComponent();

...
namespace QD.ERP.Web.Areas.Finance.Reports.Payable_Statements
{
    ...
    {
        private const string QueryName = "qry201SubLedgerPayablesMasterWtZeroBalance";
        private readonly TenantDbContextHelper _tenantDbContextHelper;

        public BillsPayablePaid(string accountId, DateTime frmDate, DateTime toDate, string tenantName, string company_Name, string company_address, Image logoImage, string Company_Name_Ar, string company_address_arb, TenantDbContextHelper tenantDbContextHelper)
        {
        ...
        private void AddSqlQueryParameters(string accountId, DateTime frmDate, DateTime toDate)
        {
            ...
            {
                Name = QueryName,
                Sql = @"SELECT * FROM qry201SubLedgerPayablesMasterWtZeroBalance

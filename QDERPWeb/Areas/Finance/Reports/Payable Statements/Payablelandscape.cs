...
namespace QD.ERP.Web.Areas.Finance.Reports.Payable_Statements
{
    public partial class Payablelandscape : XtraReport
    {
        ...
        public Payablelandscape(string accountId, DateTime frmDate, DateTime toDate, string tenantName, string company_Name, string company_address, Image logoImage, string Company_Name_Ar, string company_address_arb)
        {
            InitializeComponent();

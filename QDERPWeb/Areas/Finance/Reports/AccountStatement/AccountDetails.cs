...
namespace QD.ERP.Web.Areas.Finance.Reports
{
    public partial class AccountDetails : XtraReport
    {
        ...
        public AccountDetails(string accountId, DateTime frmDate, DateTime toDate,string tenantName, string company_Name, string company_address, Image logoImage, string Company_Name_Ar, string company_address_arb)
        {
            InitializeComponent();

...
namespace QD.ERP.Web.Reports
{
    public partial class AccountOrderbyVchNoWONarrationReport : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public AccountOrderbyVchNoWONarrationReport(string accountId, DateTime frmDate, DateTime toDate, string tenantName, string company_Name, string company_address, Image logoImage, string Company_Name_Ar, string company_address_arb)
        {
            InitializeComponent();

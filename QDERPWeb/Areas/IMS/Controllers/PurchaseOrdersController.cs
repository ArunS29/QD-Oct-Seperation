...
public IActionResult GetAutoGeneratedPurchaseorderNumber()
{
    try
    {
        ...
        {
            _logger.LogWarning("Tenant name not found in session when generating PurchaseOrderNo.");
        ...
        // Step 5: Get existing matching Ponos
...
public async Task<IActionResult> GetByPoNo(string poNo, byte? revisionId)
{
    ...
    catch (Exception ex)
    {
        ...
        [HttpPost]
public async Task<IActionResult> SubmitPurchaseOrder([FromBody] Tbl60401purchaseOrderMaster data)
{
 ...
 try
    ...
    catch (Exception ex)
    {
        ...
        [HttpPost]
        public async Task<IActionResult> VerifyPurchaseOrder([FromBody] Tbl60401purchaseOrderMaster data)
        {
...
var po = await dbContext.Tbl60401purchaseOrderMasters.FirstOrDefaultAsync(x => x.Pono == pono );          
        ...
        [HttpPost]
        public async Task<IActionResult> ApprovePurchaseOrder([FromBody] Tbl60401purchaseOrderMaster data)
        {
...
var po = await dbContext.Tbl60401purchaseOrderMasters.FirstOrDefaultAsync(x => x.Pono == pono );                if (po == null)

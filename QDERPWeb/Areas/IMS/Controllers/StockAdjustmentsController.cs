...
namespace QD.ERP.Web.Areas.IMS.Controllers
{
    ...
    public class StockAdjustmentsController : Controller
    {
        ...
        public StockAdjustmentsController(ILogger<StockAdjustmentsController> logger, TenantDbContextHelper tenantDbContextHelper)
        {
            _tenantDbContextHelper = tenantDbContextHelper;
            _logger = logger;
        }
        [HttpGet]
        public async Task<IActionResult> GetStockAdjustment(DateTime? fromDate, DateTime? toDate)
        {

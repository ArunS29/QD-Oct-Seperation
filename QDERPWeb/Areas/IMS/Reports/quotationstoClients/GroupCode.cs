...
: DevExpress.XtraReports.UI.PageBreak.None;
        ...
        private void SetReportParameters(
                bool pageBreakBefore, string quotationNo, string tenantName, string companyName, Image logoImage, Image sealImage,
        ...
        private void LoadReportData(string quotationNo)
        {
            ...
            if (dt.Columns.Contains("currencyId") && dt.Rows[0]["currencyId"] != DBNull.Value)
            {
                ...
                {
                    foreach (string pictureBoxName in new[] { "xrPictureBox2", "xrPictureBox3", "xrPictureBox4", "xrPictureBox9", "xrPictureBox10",  "xrPictureBox8" })
                    {

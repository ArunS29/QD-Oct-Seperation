...
{
    public partial class PreviewQuotationWithSubGroup : DevExpress.XtraReports.UI.XtraReport
    {
            ...
            TenantDbContextHelper tenantDbContextHelper)
        {
            ...
            int[] labelNumbers = { 78, 80, 81, 83, 84, 85, 86, 87, 88, 90, 93, 94, 96, 97, 74 };
        ...
        //        if (FindControl("xrLabel82", true) is XRLabel labelEnglish)
        ...
        private void LoadReportData(string quotationNo)
        {
            ...
            if (dt.Columns.Contains("currencyId") && dt.Rows[0]["currencyId"] != DBNull.Value)
            {
                ...
                {
                    foreach (string pictureBoxName in new[] { "xrPictureBox1", "xrPictureBox2", "xrPictureBox4", "xrPictureBox6", "xrPictureBox7", "xrPictureBox8", "xrPictureBox9" })
                    {
        ...
        private void ApplyConditionalVisibility(bool showSeal, bool showSignature, bool printLetterhead)
        {
            ...
            foreach (string signatureBox in new[] { "xrPictureBox5", "xrPictureBox3", "xrPictureBox0" })
            {
            ...
            if (FindControl("xrLabel98", true) is XRLabel lbl75)

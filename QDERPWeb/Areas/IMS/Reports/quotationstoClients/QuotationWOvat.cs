...
namespace QD.ERP.Web.Areas.IMS.Reports.quotationstoClients
{
    public partial class QuotationWOvat : DevExpress.XtraReports.UI.XtraReport
    {
            ...
            TenantDbContextHelper tenantDbContextHelper)
        {
            ...
            int[] labelNumbers = { 17, 7, 8, 9, 10, 11, 12, 13, 14, 15, 22, 26, 60, 61, 70 };
        ...
        private void ApplyConditionalVisibility(bool showSeal, bool showSignature, bool printLetterhead)
        {
            ...
            if (FindControl("xrPictureBox9", true) is XRPictureBox sealPicture)
                sealPicture.Visible = showSeal;

            // 🔹 Signature logic (xrPictureBox5, xrPictureBox6, xrPictureBox7)
            foreach (string signatureBox in new[] { "xrPictureBox8", "xrPictureBox6", "xrPictureBox7" })
            {

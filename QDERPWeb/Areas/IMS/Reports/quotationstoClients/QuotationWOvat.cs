...
{
    public partial class QuotationWOvat : DevExpress.XtraReports.UI.XtraReport
    {
        private readonly TenantDbContextHelper _tenantDbContextHelper;

        public QuotationWOvat()
        {
            InitializeComponent();
        }
            ...
            TenantDbContextHelper tenantDbContextHelper)
        {
            ...
            InitializeComponent();
            SetReportParameters(pageBreakBefore,quotationNo, tenantName, companyName, logoImage, sealImage, companyAddress,companyNameAr, companyAddressAr,username);
...
: DevExpress.XtraReports.UI.PageBreak.None;
        ...
        private void SetReportParameters(bool pageBreakBefore, string quotationNo, string tenantName, string companyName, Image logoImage, Image sealImage,
            string companyAddress,string companyNameAr, string companyAddressAr, string username)
        {
            ...
            // Assign to labels and images if they exist
            ...
            if (FindControl("xrPictureBox9", true) is XRPictureBox sealPictureBox)
        ...
        //    {
        //        this.DataSource = dt;
        //        this.DataMember = ""; // Optional: set a specific data member if needed
        //    }
        //}
        private void LoadReportData(string quotationNo)
        {
            ...
            if (dt.Columns.Contains("currencyId") && dt.Rows[0]["currencyId"] != DBNull.Value)
            {
                ...
                {
                    foreach (string pictureBoxName in new[] { "xrPictureBox1",   })
                    {

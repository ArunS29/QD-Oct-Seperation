    ...
    public partial class WithoutDiscountInvoice : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void LoadCurrencySymbolAndImage()
        {
            try
            {
                ...
                string[] pictureBoxNames = { "xrPictureBox6", "xrPictureBox7", "xrPictureBox8", "xrPictureBox9" };
        ...
        {
            var fixedPictureBoxes = new[] {   "xrPictureBox6", "xrPictureBox7" ,"xrPictureBox8", "xrPictureBox9", "xrPictureBox10","xrPictureBox11","xrPictureBox12","xrPictureBox13" };

...
{
    public partial class PreviewCreditNoteEnglishOnly : DevExpress.XtraReports.UI.XtraReport
    {
        private readonly TenantDbContextHelper _tenantDbContextHelper;
        private bool _isApproved;


        public PreviewCreditNoteEnglishOnly(
        string creditNoteNo,
            string tenantName,
            string companyName,
        ...
        TenantDbContextHelper tenantDbContextHelper)
        {
            ...
            InitializeComponent();
            SetReportParameters(creditNoteNo, tenantName, companyName, companyAddress, companyNameAr, companyAddressAr, userName);
        ...
        private void SetReportParameters(string creditNoteNo, string tenantName, string companyName, string companyAddress, string companyNameAr, string companyAddressAr, string userName)
        {
        ...
        {
            var fixedPictureBoxes = new[] { "xrPictureBox4","xrPictureBox2",

...
namespace QD.ERP.Web.Areas.VAT.Reports.VATCreditNote
{
    public partial class CreditForeignCurrency : XtraReport
    {
            ...
            TenantDbContextHelper tenantDbContextHelper)
        {
            ...
            InitializeComponent();
            SetReportParameters(creditNoteNo, tenantName, companyName, companyAddress, logoImage, companyNameAr, companyAddressAr, username);
            LoadReportData(creditNoteNo);
            LoadCurrencySymbolAndImage();
        }

        private void SetReportParameters(string creditNoteNo, string tenantName, string companyName, string companyAddress, Image logoImage, string companyNameAr, string companyAddressAr, string username)
        {
        ...
        private void CreditNotes_BeforePrint(object sender, CancelEventArgs e)
        {
            // Optional: Add logic before printing
        }
        private void LoadCurrencySymbolAndImage()
        {
            try
            {
                ...
                string[] pictureBoxNames = { "xrPictureBox2", "xrPictureBox4", "xrPictureBox5", "xrPictureBox6", "xrPictureBox7", "xrPictureBox8", "xrPictureBox9", "xrPictureBox10" };
        ...
        {
            string[] pictureBoxNames = { "xrPictureBox1", "xrPictureBox3", "xrPictureBox2", "xrPictureBox6", "xrPictureBox7", "xrPictureBox8", "xrPictureBox9", "xrPictureBox10" };
        ...
        {
            var fixedPictureBoxes = new[] { "xrPictureBox1", "xrPictureBox3", "xrPictureBox2", "xrPictureBox5", "xrPictureBox6", "xrPictureBox7", "xrPictureBox4", "xrPictureBox9", "xrPictureBox10", "xrPictureBox11", "xrPictureBox12", "xrPictureBox13", "xrPictureBox14", "xrPictureBox15", "xrPictureBox16", "xrPictureBox17", "xrPictureBox18", "xrPictureBox19", "xrPictureBox20" };

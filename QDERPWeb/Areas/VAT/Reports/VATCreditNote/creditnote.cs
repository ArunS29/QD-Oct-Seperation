	...
	{	
        ...
        private void LoadReportData(string creditNoteNo)
        {
            ...
            else
            {
                ...
                if (FindControl("xrLabel83", true) is XRLabel labelEnglish)

                    labelEnglish.Text = $"Amount in Words: {NumberToWordsHelper.ToEnglishWords(totalAmount)}";

                if (FindControl("xrLabel100", true) is XRLabel labelArabic)
        ...
        private void SetWatermark()
        {
            if (!_isApproved)
            {
                ...
                this.Watermark.ForeColor = Color.FromArgb(128, 0, 140, 255);
        ...
        private void LoadCurrencySymbolAndImage()
        {
            try
            {
                ...
                string[] pictureBoxNames = { "xrPictureBox4", "xrPictureBox3" };
        ...
        {
            string[] pictureBoxNames = { "xrPictureBox3", "xrPictureBox4" };

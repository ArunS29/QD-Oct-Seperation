...
{
    public partial class Quotation_With2Rates_ : DevExpress.XtraReports.UI.XtraReport

    {
        ...
        private void LoadReportData(string quotationNo)
        {
            ...
            if (dt.Columns.Contains("currencyId") && dt.Rows[0]["currencyId"] != DBNull.Value)
            {
                ...
                {
                    foreach (string pictureBoxName in new[] { "xrPictureBox1", "xrPictureBox2", "xrPictureBox5" })
                    {

...
{
    public partial class Quotation_Mob_DemobDetails_ : DevExpress.XtraReports.UI.XtraReport

    {
        ...
        public Quotation_Mob_DemobDetails_()
        ...
        private void LoadReportData(string quotationNo)
        {
            ...
            if (dt.Columns.Contains("currencyId") && dt.Rows[0]["currencyId"] != DBNull.Value)
            {
                ...
                {
                    foreach (string pictureBoxName in new[] { "xrPictureBox1", "xrPictureBox3", "xrPictureBox2" })
                    {

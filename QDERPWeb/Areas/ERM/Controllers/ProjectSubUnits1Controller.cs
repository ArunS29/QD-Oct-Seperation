...
namespace QD.ERP.Web.Areas.ERM.Controllers
{
    ...
    [ApiController]
    public class ProjectSubUnits1Controller : Controller
    {
        private readonly TenantDbContextHelper _tenantDbContextHelper;
        private readonly ILogger<ProjectSubUnits1Controller> _logger;

        public ProjectSubUnits1Controller(ILogger<ProjectSubUnits1Controller> logger, TenantDbContextHelper tenantDbContextHelper)
        {

...
namespace QD.ERP.Web.Areas.ERM.Controllers
{
    ...
    [ApiController]
    public class ClientCategory2Controller : ControllerBase
    {
        private readonly TenantDbContextHelper _tenantDbContextHelper;
        private readonly ILogger<MasterController> _logger;

        public ClientCategory2Controller(ILogger<MasterController> logger, TenantDbContextHelper tenantDbContextHelper)
        {

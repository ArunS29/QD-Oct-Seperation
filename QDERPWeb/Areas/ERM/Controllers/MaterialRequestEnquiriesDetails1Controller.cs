...
namespace QD.ERP.Web.Areas.ERM.Controllers
{
	...
	[ApiController]
	public class MaterialRequestEnquiriesDetails1Controller : Controller
	{
		private readonly TenantDbContextHelper _tenantDbContextHelper;
		private readonly ILogger<MaterialRequestEnquiriesDetails1Controller> _logger;

		public MaterialRequestEnquiriesDetails1Controller(ILogger<MaterialRequestEnquiriesDetails1Controller> logger, TenantDbContextHelper tenantDbContextHelper)
		{
		...
		public IActionResult DeletePurchaseRequest(string Mprno)
		{
			if (_tenantDbContextHelper.TryGetTenantAndDbContext(out Tenant tenant, out ERPMasterWtDataContext dbContext))
			{
				try
				{
					...
					// Log the deletion
					//InsertUserEntryLogSheet("ERM Purchase Request", $"ERM Purchase Request Ref No. {Mprno} has been deleted by User ID: {User.Identity.Name}.", User.Identity.Name, Mprno);

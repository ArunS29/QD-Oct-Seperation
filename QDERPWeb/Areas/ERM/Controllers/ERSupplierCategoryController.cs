...
namespace QD.ERP.Web.Areas.ERM.Controllers
{
    ...
    [ApiController]
    public class ERSupplierCategoryController : ControllerBase
    {
        private readonly TenantDbContextHelper _tenantDbContextHelper;
        private readonly ILogger<ERSupplierCategoryController> _logger;

        public ERSupplierCategoryController(ILogger<ERSupplierCategoryController> logger, TenantDbContextHelper tenantDbContextHelper)
        {

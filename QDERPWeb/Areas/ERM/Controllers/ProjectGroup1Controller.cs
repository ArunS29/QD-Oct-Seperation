...
namespace QD.ERP.Web.Areas.ERM.Controllers
{
    ...
    [ApiController]
    public class ProjectGroup1Controller : Controller
    {
        private readonly TenantDbContextHelper _tenantDbContextHelper;
        private readonly ILogger<ProjectGroup1Controller> _logger;

        public ProjectGroup1Controller(ILogger<ProjectGroup1Controller> logger, TenantDbContextHelper tenantDbContextHelper)
        {
        ...
        public async Task<IActionResult> GetAllProjectGroupData()
        {
            ...
            {
                _logger.LogError(ex, "Error in ProjectGroup1Controller");

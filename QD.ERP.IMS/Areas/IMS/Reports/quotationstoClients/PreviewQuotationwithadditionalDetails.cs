...
namespace QD.ERP.IMS.Areas.IMS.Report.Inventory_Report
{
    public partial class PreviewQuotationwithadditionalDetails : DevExpress.XtraReports.UI.XtraReport
    {
            ...
            TenantDbContextHelper tenantDbContextHelper)
        {
            ...
            int[] labelNumbers = { 74, 75, 76, 77, 78, 79, 80, 81, 82, 83, 84, 85, 86, 87, 88 };
        ...
        private void ApplyConditionalVisibility(bool showSeal, bool showSignature, bool printLetterhead)
        {
            ...
            if (FindControl("xrLabel92", true) is XRLabel lbl75)
                lbl75.Visible = printLetterhead;

            if (FindControl("xrLabel93", true) is XRLabel lbl76)
            ...
            if (FindControl("xrLabel96", true) is XRLabel lbl96)
                lbl96.Visible = printLetterhead;
            if (FindControl("xrLabel97", true) is XRLabel lbl97)
                lbl97.Visible = printLetterhead;
            if (FindControl("xrLabel98", true) is XRLabel lbl98)
                lbl98.Visible = printLetterhead;

...
namespace QD.ERP.IMS.Areas.IMS.Reports.InventroryReports.PurchaseOrder
{
    public partial class PreviewPurchaseOrderForeignCurrency : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        //        if (FindControl("xrLabel70", true) is XRLabel labelEnglish)
 ...
 bool ShowSignatoryPositionOnly
)
        {
            ...
            if (FindControl("xrLabel79", true) is XRLabel lbl79)
                lbl79.Visible = printLetterhead;

            if (FindControl("xrLabel78", true) is XRLabel lbl78)
                lbl78.Visible = printLetterhead;
            ...
            // Hide all first
            foreach (string lbl in new[] { "xrLabel84", "xrLabel82", "xrLabel81", "xrLabel80", "xrLabel24", "xrLabel33" })
            {
            ...
            if (ShowitemPartNumberinsteadStockCode && ShowHSCodeinsteadStockCode)
            {
                ...
                if (FindControl("xrLabel33", true) is XRLabel l33) l33.Visible = true;
                if (FindControl("xrLabel82", true) is XRLabel l82) l82.Visible = true;
            }
            else if (ShowitemPartNumberinsteadStockCode)
            {
                ...
                if (FindControl("xrLabel84", true) is XRLabel l84) l84.Visible = true;
            }
            ...
            else
            {
                ...
                if (FindControl("xrLabel81", true) is XRLabel l81) l81.Visible = true;
            }
        ...
        private void LoadReportData(string purchaseOrderNo)
        {
            ...
            if (dt.Columns.Contains("currencyId") && dt.Rows[0]["currencyId"] != DBNull.Value)
            {
                ...
                {
                    foreach (string pictureBoxName in new[] { "xrPictureBox5", "xrPictureBox6", "xrPictureBox7", "xrPictureBox8", "xrPictureBox9", "xrPictureBox10", "xrPictureBox11", "xrPictureBox12" , "xrPictureBox13", "xrPictureBox14" })
                    {

...
{
	public partial class ProformaNewFormat : DevExpress.XtraReports.UI.XtraReport
	{	
        ...
        private void LoadReportData(string invoiceNo)
        {
            ...
            else
            {
                ...
                if (FindControl("xrLabel165", true) is XRLabel labelEnglish)

                    labelEnglish.Text = $"Amount in Words: {NumberToWordsHelper.ToEnglishWords(totalAmount)}";

                if (FindControl("xrLabel166", true) is XRLabel labelArabic)

...
namespace QD.ERP.VAT.Areas.VAT.Reports.ProformaInvoices
{
    public partial class Wtdiscountpreviewinvoice : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private DataTable GetReportData(string invoiceNo)
        {
            ...
            try
            {
                if (_tenantDbContextHelper.TryGetTenantAndDbContext(out var tenant, out var _))
                {
                    ...
                    {
                        string query = "SELECT * FROM qry202_652WtdiscountInvoiceReport WHERE ProformaInvoiceNo = @ProformaInvoiceNo";
        ...
        {
            var fixedPictureBoxes = new[] { "xrPictureBox5", "xrPictureBox6", "xrPictureBox7", "xrPictureBox8" ,"xrPictureBox9", "xrPictureBox10", "xrPictureBox11", "xrPictureBox12",

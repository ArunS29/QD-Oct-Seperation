...
namespace QD.ERP.VAT.Areas.VAT.Reports.B2B_INVOICE
{
    public partial class PrintsimplifiedTaxInvoices : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public PrintsimplifiedTaxInvoices()
        {
            InitializeComponent();
        }
        ...
        private void SetReportParameters(string invoiceNo, string tenantName, string companyName, string companyAddress, Image logoImage,  string companyNameAr, string companyAddressAr, string companyPhone, string companyEmail, string companyWebsite)
        {
            ...
            if (FindControl("xrPictureBox12", true) is XRPictureBox logoPictureBox)
        ...
        private void LoadReportData(string invoiceNo)
        {
            ...
            else
            {
                ...
                if (FindControl("xrLabel88", true) is XRLabel labelEnglish)
        ...
        {
            var fixedPictureBoxes = new[] { "xrPictureBox2", "xrPictureBox3", "xrPictureBox4", "xrPictureBox5", "xrPictureBox6", "xrPictureBox7","xrPictureBox8", "xrPictureBox9", "xrPictureBox10", "xrPictureBox11",  "xrPictureBox13", "xrPictureBox14", "xrPictureBox15", "xrPictureBox16" };

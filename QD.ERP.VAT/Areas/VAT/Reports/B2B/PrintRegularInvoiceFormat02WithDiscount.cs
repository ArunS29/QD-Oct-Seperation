...
{
    public partial class PrintRegularInvoiceFormat02WithDiscount : XtraReport
    {
        ...
        {
            var fixedPictureBoxes = new[] {  "xrPictureBox6" ,
                "xrPictureBox7", "xrPictureBox8", "xrPictureBox9", "xrPictureBox10", "xrPictureBox11", "xrPictureBox12" ,"xrPictureBox13" };

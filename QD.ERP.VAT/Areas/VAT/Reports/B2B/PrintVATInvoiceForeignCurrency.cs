...
{
    public partial class PrintVATInvoiceForeignCurrency : DevExpress.XtraReports.UI.XtraReport
    {
        private readonly TenantDbContextHelper _tenantDbContextHelper;
        private bool _isApproved;


        public PrintVATInvoiceForeignCurrency(
                         bool showSeal,
bool showSignature,
...
bool useDateFormat2,
        ...
        private void ApplyConditionalVisibility(bool showSeal, bool showSignature, bool printLetterhead,bool useDateFormat)
        {
            ...
            foreach (string signatureBox in new[] { "xrPictureBox2" })
            {
            ...
            if (FindControl("xrLine1", true) is XRLine line1)
                line1.Visible = printLetterhead;
        }

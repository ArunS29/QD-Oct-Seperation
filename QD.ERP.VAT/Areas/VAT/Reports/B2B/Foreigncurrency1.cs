	...
	{	
        ...
        private void LoadCurrencySymbolAndImage()
        {
            ...
            INNER JOIN dbo.fn_GetDefaultCompanyDetails() AS f
                ...
                string[] pictureBoxNames = {  "xrPictureBox6", "xrPictureBox8", "xrPictureBox7", "xrPictureBox8", "xrPictureBox9", "xrPictureBox10",  "xrPictureBox12", };
        ...
        {
            var fixedPictureBoxes = new[] {  "xrPictureBox6", "xrPictureBox7", "xrPictureBox8", "xrPictureBox9", "xrPictureBox10", "xrPictureBox12", "xrPictureBox13", "xrPictureBox14", "xrPictureBox15", "xrPictureBox16" };

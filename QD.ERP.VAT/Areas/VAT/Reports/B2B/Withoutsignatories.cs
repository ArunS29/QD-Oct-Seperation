...
{
    public partial class Withoutsignatories : XtraReport
    {
        private readonly TenantDbContextHelper _tenantDbContextHelper;
        private bool _isApproved;

        public Withoutsignatories(
                         bool showSeal,
bool showSignature,
...
bool useDateFormat2,
        ...
        private void SetReportParameters(string invoiceNo, string tenantName, string companyName, string companyAddress, Image logoImage, Image sealImage, string companyNameAr, string companyAddressAr)
        {
            ...
            if (FindControl("txtCompanyLogo", true) is XRPictureBox logoPictureBox)
        ...
        private void LoadReportData(string invoiceNo)
        {
            ...
            else
            {
                ...
                if (FindControl("xrLabel72", true) is XRLabel labelEnglish)

                    labelEnglish.Text = $"Amount in Words: {NumberToWordsHelper.ToEnglishWords(totalAmount)}";

                if (FindControl("xrLabel102", true) is XRLabel labelArabic)
        ...
        private void LoadCurrencySymbolAndImage()
        {
            ...
            INNER JOIN dbo.fn_GetDefaultCompanyDetails() AS f
                ...
                string[] pictureBoxNames = { "xrPictureBox6", "xrPictureBox8" };
        ...
        {
            string[] pictureBoxNames = { "xrPictureBox8" };
        ...
        {
            var fixedPictureBoxes = new[] { "xrPictureBox2", "xrPictureBox1", "xrPictureBox3", "xrPictureBox4", "xrPictureBox6", "xrPictureBox7", "xrPictureBox8", "xrPictureBox9", "xrPictureBox10", "xrPictureBox11", "xrPictureBox12", "xrPictureBox13", "xrPictureBox14", "xrPictureBox15", "xrPictureBox16" };

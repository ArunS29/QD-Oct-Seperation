...
bool useDateFormat2,
        ...
        private void LoadReportData(string invoiceNo)
        {
            ...
            else
            {
                ...
                if (FindControl("xrLabel6", true) is XRLabel labelEnglish)

                    labelEnglish.Text = $"Amount in Words: {NumberToWordsHelper.ToEnglishWords(totalAmount)}";

                if (FindControl("xrLabel7", true) is XRLabel labelArabic)
        ...
        {
            var fixedPictureBoxes = new[] { "xrPictureBox1", "xrPictureBox3", "xrPictureBox4", "xrPictureBox5", "xrPictureBox6", "xrPictureBox7", "xrPictureBox8", "xrPictureBox9", "xrPictureBox10", "xrPictureBox11", "xrPictureBox12", "xrPictureBox13", "xrPictureBox14", "xrPictureBox15", "xrPictureBox16" };

...
namespace QD.ERP.Web.Areas.VAT.Reports.B2B
{
    public partial class PrintRegularTaxInvoiceWtDocumentLevelDiscount : XtraReport
    {
        ...
        private void SetReportParameters(string invoiceNo, string tenantName, string companyName, string companyAddress, Image logoImage, Image sealImage, string companyNameAr, string companyAddressAr)
        {
            ...
            if (FindControl("xrPictureBox12", true) is XRPictureBox sealPictureBox)
        ...
        private void LoadReportData(string invoiceNo)
        {
            ...
            else
            {
                ...
                if (FindControl("xrLabel135", true) is XRLabel labelEnglish)

                    labelEnglish.Text = $"Amount in Words: {NumberToWordsHelper.ToEnglishWords(totalAmount)}";

                if (FindControl("xrLabel63", true) is XRLabel labelArabic)
        ...
        private void AlignCurrencyWithAmount(Bitmap bitmap, float iconSize = 14f, float padding = 12f)
        {
            var fixedPictureBoxes = new[] {  "xrPictureBox5", "xrPictureBox6" ,
                "xrPictureBox7", "xrPictureBox8", "xrPictureBox9", "xrPictureBox10", "xrPictureBox11", "xrPictureBox4", "xrPictureBox13", "xrPictureBox14", "xrPictureBox15" };
